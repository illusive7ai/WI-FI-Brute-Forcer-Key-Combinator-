@echo off
	...
	cd BF_Files
	title The WI-FI Brute Forcer - Developed By ILLUSIVEHACKS
	set /a attempt=1
	del attempt.xml
	del infogate.xml
	cls
    ...
    echo.                                Illusive Tools
    echo  [---------------------------------------------------------------------------]
    echo.                       Brute Force Manager Version 1.1.2 
    echo.
    echo.                       Developed By ILLUSIVEHACKS
    echo.
    echo  [---------------------------------------------------------------------------]
    echo.
    pause
	...
	if !mainmenuchoice!==help (
		...
		echo.
		echo.
		echo  Other projects of Illusivehacks:
		echo  "https://github.com/juicetreacly"
		echo.
		echo  This project's UI has maden possible with Cipher group.
		echo  "https://whatsapp.com/channel/0029VaKenMe0LKZEAnWle521"
		echo.
		echo  Press any key to continue...
		pause >nul
		cls
